...
router.post("/users", modifyLimiter, logActivity("CREATE_USER"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.post("/users/:userId/toggle", modifyLimiter, logActivity("TOGGLE_USER_STATUS"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.delete("/users/:userId", modifyLimiter, logActivity("DELETE_USER"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.post("/problem-statements", modifyLimiter, logActivity("CREATE_PROBLEM_STATEMENT"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.put("/problem-statements/:id", modifyLimiter, logActivity("UPDATE_PROBLEM_STATEMENT"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.delete("/problem-statements/:id", modifyLimiter, logActivity("DELETE_PROBLEM_STATEMENT"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.post("/problem-statements/lock", modifyLimiter, logActivity("TOGGLE_PS_LOCK"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
// Team Management
router.get("/teams", async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.get("/teams/:teamId", async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.post("/teams/create", modifyLimiter, logActivity("CREATE_TEAM"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
// Delete a team
router.delete("/teams/:teamId", modifyLimiter, logActivity("DELETE_TEAM"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.get("/team/:teamId/checkpoint1", async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
// System Settings
router.post("/mentorship/lock", modifyLimiter, logActivity("TOGGLE_MENTORSHIP_LOCK"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.post("/round1/lock", modifyLimiter, logActivity("TOGGLE_ROUND1_LOCK"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.post("/mentors", logActivity("CREATE_MENTOR"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.delete("/mentors/:mentorId", modifyLimiter, logActivity("DELETE_MENTOR"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.get("/logs", async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const logs = await superAdminService.getActivityLogs(req.query as LogFilter);
    res.json(logs);
  } catch (error) {
    next(error);
  }
...
router.post("/announcements", modifyLimiter, logActivity("CREATE_ANNOUNCEMENT"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
// Team-Judge Mapping
router.get("/team-judge-mappings", async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.post("/team-judge-mappings", modifyLimiter, logActivity("MAP_TEAM_TO_JUDGE"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.get("/judges", async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.post("/judges", logActivity("ADD_JUDGE"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.delete("/judges/:judgeId", logActivity("REMOVE_JUDGE"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.get("/team-scores", async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
// Round 2 Management
router.post("/round2/promote", modifyLimiter, logActivity("PROMOTE_TO_ROUND2"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.get("/round2/rooms", async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.post("/round2/rooms", modifyLimiter, logActivity("CREATE_ROUND2_ROOM"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.delete("/round2/rooms/:roomId", modifyLimiter, logActivity("DELETE_ROUND2_ROOM"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.post(["/round2/assign-judge", "/round2/map-judge"], modifyLimiter, logActivity("ASSIGN_JUDGE_TO_ROOM"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.delete("/round2/judges/:judgeId", modifyLimiter, logActivity("REMOVE_JUDGE_FROM_ROUND2_ROOM"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.post("/round2/assign-team", modifyLimiter, logActivity("ASSIGN_TEAM_TO_ROOM"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
// Round 3 Management
router.get("/round3/candidates", async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.post("/round3/select-top", modifyLimiter, logActivity("SELECT_TOP_TEAMS_ROUND3"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.get("/round3/rooms", async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.post("/round3/assign-judge", modifyLimiter, logActivity("ASSIGN_JUDGE_ROUND3_ROOM"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.delete("/round3/judge/:judgeId", modifyLimiter, logActivity("REMOVE_JUDGE_ROUND3_ROOM"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.post("/round3/auto-assign", modifyLimiter, logActivity("AUTO_ASSIGN_ROUND3_TEAMS"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.post("/round3/assign-team", modifyLimiter, logActivity("ASSIGN_TEAM_ROUND3_ROOM"), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
