...
// Judge-Team Mapping
router.get("/judge-mappings", async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.get("/judges/:judgeId", async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.get("/logs", async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const logs = await adminService.getActivityLogs(req.query as LogFilter);
    res.json(logs);
  } catch (error) {
    next(error);
  }
...
router.get("/team/:teamId/checkpoints", async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.get("/team/:teamId/participants", async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
